...
function randomMineSet(gNumOfMines, board, cellI, cellJ) {
    ...
    while (minesPlaced < gNumOfMines) {
        ...
        // CR: the conditions to make sure there will be no bomb on the specific cell are a bit wrong
        if (i === cellI) continue;
...
// CR: no use of variable board in function
